...
/* ── TEAM DATA & RENDER ── */
const team = [
  { handle:'pran0x', role:'Team Lead', bio:'XSS, SQLi, SSRF — a full stack of destruction.', tags:['web','xss','sqli'], seed:9024, img:'./assets/img/crews/pran0x.png', active:true, social:{linkedin:'#',x:'#',github:'https://github.com/pran0x'} },
  { handle:'S4M', role:'Admin', bio:'Disassembles firmware for fun. Malware analyst by night.', tags:['Reverse Engineering','malware','ida'], seed:3847, img:'./assets/img/crews/nahid.png', active:true, social:{linkedin:'#',x:'#',github:'#'} },
  { handle:'x!ku7inG', role:'Member', bio:'Breaks RSA before breakfast. Lattice sorcerer.', tags:['PWN','OSINT'], seed:6193, img:'./assets/img/crews/ziku.png', active:true, social:{linkedin:'#',x:'#',github:'#'} },
  ...
  { handle:'khaled0x0', role:'Formal Captain', bio:'Android & reverse engineering specialist.', tags:['Android','Reverse Engineering'], seed:8816, img:'./assets/img/formal-crews/khaled.png', active:false, social:{linkedin:'#',x:'#',github:'#'} },
  { handle:'id3ologica1_smuggl3r', role:'Admin',bio:'Analyzes digital evidence to solve cases.', tags:['Forensics','Crypto'], seed:1459, img:'./assets/img/formal-crews/sani.png', active:false, social:{linkedin:'#',x:'#',github:'#'} }
];
...
if(grid){
  team.forEach((m, i) => {
    ...
    const socialLinks = m.social ? `
      <div class="member-social">
        <a href="${m.social.linkedin}" target="_blank" rel="noopener noreferrer" class="social-icon linkedin" title="LinkedIn" aria-label="LinkedIn">
          <svg viewBox="0 0 24 24" fill="currentColor"><path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/></svg>
        </a>
        <a href="${m.social.x}" target="_blank" rel="noopener noreferrer" class="social-icon x" title="X (Twitter)" aria-label="X">
        ...
        <a href="${m.social.github}" target="_blank" rel="noopener noreferrer" class="social-icon github" title="GitHub" aria-label="GitHub">
